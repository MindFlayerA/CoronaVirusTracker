/*First we will make a request to have the values in the local Storage.*/
...
let chartConfig = {
    ...
    series: [
      {
        text: 'Active',
        values: [100-(countRecoveredValue/countConfirmedValue*100+ countDeathValue/countConfirmedValue*100)],
        backgroundColor: '#db9812'
      },
      {
        text: 'Recovered',
        values: [countRecoveredValue/countConfirmedValue*100],
        backgroundColor: '#039127'
      },
      {
        text: 'Death',
        values: [countDeathValue/countConfirmedValue*100],
        backgroundColor: '#fc2119'
      }
    ]
  };
...
var response = localStorage.getItem('series');
...
scaleX: {
 ...
 lineColor: '#E3E3E5',
 minValue:1579631400000,
 step: 'day',
 transform: {
   type: 'date',
   all: '%D %M %d<br>%h:%i:%s %A'
 },
 zooming: true,
 zoomTo: [0, 15]
},
...
//EVENTS
//-----------------------------
zingchart.bind('worldGraphical', 'shape_click', function (p) {
